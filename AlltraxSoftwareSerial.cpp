...
AlltraxSoftwareSerial::AlltraxSoftwareSerial(SoftwareSerial *inSer) 
{
   _Serial = inSer;
   _Serial->begin(9600);
}
...
int AlltraxSoftwareSerial::readTemp(){
...
int AlltraxSoftwareSerial::readThrottle(){
...
float AlltraxSoftwareSerial::readThrottlePercent(){
...
float AlltraxSoftwareSerial::readVoltage(){
...
float AlltraxSoftwareSerial::readCurrent(){
...
float AlltraxSoftwareSerial::readBatteryCurrent(){
  ...
  int throttle = readThrottle();//Does this need to be throttle percent?-------------------------------------------------------------------------------------------------------------------------
  throttle = throttle/100;
  float batteryCurrent = throttle * OutCur;
  return batteryCurrent;
}

boolean AlltraxSoftwareSerial::resetController(){
...
byte AlltraxSoftwareSerial::readShutdown(){
...
int AlltraxSoftwareSerial::readMaxCurrent(){
...
boolean AlltraxSoftwareSerial::setMaxCurrent(int Percent){
...
int AlltraxSoftwareSerial::readThrottleUpRate(){
...
boolean AlltraxSoftwareSerial::setThrottleUpRate(int Up){
  //sets the motor controller Max Current to the percent provided
  //Pre: None
  //Post: returns true if there were no errors,
  //      false if there was an error
...
int AlltraxSoftwareSerial::readTopSpeed(){
...
boolean AlltraxSoftwareSerial::setTopSpeed(int MaxSpeed){
...
boolean AlltraxSoftwareSerial::sendCommand(byte sendArray[]){
...
byte* AlltraxSoftwareSerial::requestResponse(byte sendArray[]){
...
boolean AlltraxSoftwareSerial::responseDelay(){
...
byte AlltraxSoftwareSerial::twoComplement(byte val){
